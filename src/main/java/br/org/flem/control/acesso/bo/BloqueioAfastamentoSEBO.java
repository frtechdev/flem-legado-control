 ...
 * @author ILFernandes
 */
public class BloqueioAfastamentoSEBO extends BaseBOAb<BloqueioAfastamentoAD> {

    public BloqueioAfastamentoSEBO() throws AplicacaoException {
    ...
    public Object schedularBloqueio(BloqueioAfastamentoAD schedule) throws AplicacaoException {
        try {
            ...
            if (schedule.getDataInicio().before(data)) {
                AutenticacaoSenhaBO sebo = new AutenticacaoSenhaBO();
                sebo.bloquearAcessos(schedule.getUsuario(), true);
            }
            ...
            throw new AplicacaoException("Erro ao tentar cadastrar agendamento");
        }
    }
    ...
    public Map<Integer, BloqueioAfastamentoAD> getMapBloqueios() throws AplicacaoException {
        ...
        for (BloqueioAfastamentoAD bl : this.obterTodos()) {
            if(bl.getUsuario().getTipoAutenticacao().equals(TipoAutenticacao.SENHA)){
