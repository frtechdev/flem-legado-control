...
<html:form action="Funcionalidade.do?metodo=alterar" onsubmit="return validar(this);">
    <html:hidden property="id" />
      <table>
        ...
        <td><html:select property="idAplicacao" value="${aplicacao.id}" styleClass="requerido" >
            <html:optionsCollection property="listaAplicacao" value="id" label="nomeCurto" styleClass="requerido" />
        </html:select>  </td></tr>
        <tr><td>Descrição: </td>
