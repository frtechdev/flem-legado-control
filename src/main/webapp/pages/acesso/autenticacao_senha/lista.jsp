...
<h2>Lista de funcionários  (Autenticação Senha)</h2>
<html:form action="AutenticacaoSenha.do" >
    <table>
        <tr>
            <td>Nome:</td>
            <td><html:text property="nome" size="50" value="${seAction_filtro_nome}"/></td>
        </tr>
        <tr>
    ...
    <display:table id="usuario" name="lista" defaultsort="1" sort="list" export="false" excludedParams="metodo" requestURI="./AutenticacaoSenha.do" pagesize="30"  class="tabelaDisplay">
        ...
        <acesso:verificaPermissao funcionalidade="bloqueioAD">
            <display:column title="Status" sortable="true">
                ...
                <c:if test="${usuario.bloqueadoSe}">
                    <html:link  href="./AutenticacaoSenha.do?metodo=desbloquear&id=${usuario.id}" >
                ...
                <c:if test="${!usuario.bloqueadoSe}">
                    <html:link  href="./AutenticacaoSenha.do?id=${usuario.id}&metodo=bloquear"   >
            ...
            <display:column title="Agendamento">
                <html:link  href="./AutenticacaoSenha.do?id=${usuario.id}&metodo=agendar"  >
